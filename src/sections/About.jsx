...
import {
    ContactsIcon, GitIcon, GsapIcon, NodeIcon, ReactIcon, ShadCnIcon, TailwindIcon, ThreeJsIcon, TsIcon, ZodIcon
...
export default function About() {
    ...
    return (<section className="xl:container mx-auto c-space my-20" id="about">
        <div
            ...
            <div className=" col-span-1 xl:row-span-3 w-full">
                <div
                    ...
                    <p>
                        ...
                        with <span className="font-bold">Node.js/Express, GSAP, shadCn Git</span> to build
            ...
            <div className=' col-span-1 xl:row-span-4'>
                <div className="grid-container overflow-hidden flex max-sm:justify-center max-sm:items-center">
